module github.com/busyfit-admin/busyfit-admin/saas-ddb-data-stack/lambdas/tenant-lambdas/ddb-stream-forwarder

go 1.21

toolchain go1.21.7

replace github.com/busyfit-admin/saas-ddb-data-stack/lambdas/lib/clients => ../../lib/clients

replace github.com/busyfit-admin/saas-ddb-data-stack/lambdas/lib/company-lib => ../../lib/company-lib
...
require (
	...
	github.com/busyfit-admin/saas-ddb-data-stack/lambdas/lib/clients v0.0.0-00010101000000-000000000000
)
