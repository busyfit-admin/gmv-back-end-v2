module github.com/busyfit-admin/saas-integrated-apis/lambdas/tenant-lambdas/rewards-module/update-rewards
...
replace github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/user-lib => ../../../lib/user-lib
...
require (
	...
	github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/user-lib v0.0.0-00010101000000-000000000000
)
