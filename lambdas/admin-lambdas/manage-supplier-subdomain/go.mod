module github.com/busyfit-admin/saas-integreted-apis/lambdas/admin-lambdas/manage-supplier-sub-domain

go 1.21.4

replace github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/clients => ../../lib/clients

replace github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/admin-lib => ../../lib/admin-lib/supplier
...
require (
	...
	github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/admin-lib v0.0.0-00010101000000-000000000000
)
