module github.com/busyfit-admin/saas-integreted-apis/lambdas/admin-lambdas/manage-tenant-profiles

go 1.21.4

replace github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/clients => ../../lib/clients

replace github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/admin-lib => ../../lib/admin-lib/tenant
