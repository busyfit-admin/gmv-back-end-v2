@dynamodb_delete_SupplierDetailsTable_SupplierId_testsupplierId1
@dynamodb_delete_SupplierDetailsTable_SupplierId_testsupplierId2
@dynamodb_delete_SupplierDetailsTable_SupplierId_testsupplierId3
@dynamodb_delete_SupplierDetailsTable_SupplierId_testsupplierId4

@end2endAdmin

Feature: Manage Supplier Profiles APIs

    Scenario Outline: GET API call made to the Supplier Details
        ...
        And row for DynamoDB table SupplierDetailsTable has the data supplier_data
            | supplier_data                                               |
            | testdata/supplier/manage-supplier-profiles/scenario-1/tabledata1.json  |
            | testdata/supplier/manage-supplier-profiles/scenario-1/tabledata2.json  |
            | testdata/supplier/manage-supplier-profiles/scenario-1/tabledata3.json  |
            | testdata/supplier/manage-supplier-profiles/scenario-1/tabledata4.json  |
     ...
     Examples: API calls to the Lambda
        ...
        | testdata/supplier/manage-supplier-profiles/scenario-1/get_api_call1.json | testdata/supplier/manage-supplier-profiles/scenario-1/lambda_response1.json |
