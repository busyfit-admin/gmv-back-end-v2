module github.com/busyfit-admin/saas-integreted-apis/cfn_handler_resources/load-default-data

go 1.21.4

replace github.com/busyfit-admin/saas-integrated-apis/lambdas/lib/clients => ../../lambdas/lib/clients
